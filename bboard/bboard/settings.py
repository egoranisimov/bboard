...
SECRET_KEY = 'django-insecure-ash9@%46dts=l0zjcw1%o^6cdb=dw!he^*%5$9d6^sh5_y-fg*'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'boardapp/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [BASE_DIR / "boardapp/static"]
